...
var util = require('util'),
    ...
    Cassandra = require('./cassandra/1.1/Cassandra'),
    ttype = require('./cassandra/1.1/cassandra_types'),
    Row = require('./row'),
    zlib = require('zlib'),
...
Connection.prototype.connect = function(callback){
   ...
   */
  function onCqlVersionSelected(err) {
