 ...
 * @param {Object} options Options for the get, can have start, end, max, consistencyLevel <br />
 *   start is the from part of the column name <br />
 *   end is the to part of the column name <br />
 *   max is the max amount of columns to return <br />
 *   consistencyLevel is the read consistency level
